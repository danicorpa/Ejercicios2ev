...
public class CosasDeAves {
    ...
    public static void imprimeCantidad(){
        ...
        System.out.print("La ración adecuada para este "+eligeAve()+" es de "+recibeCantidad(pidePeso(), pideEdad())+"gr");

    }
    public static String eligeAve(){
        Scanner sc = new Scanner(System.in);
        System.out.println("Introduce el tipo de ave: ");
        return sc.nextLine();
